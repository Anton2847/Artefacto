...
public final class ActivityNotificationsBinding implements ViewBinding {
  ...
  private ActivityNotificationsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView ivBackNotif, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView rvMyTicket, @NonNull TextView tvTitle) {
  ...
  public static ActivityNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNotificationsBinding((ConstraintLayout) rootView, backgroundImageView,
          cvHeader, ivBackNotif, progressBar, rvMyTicket, tvTitle);
    }
